...
- [⚡ Quant Alpha Engine](#-quant-alpha-engine)
  ...
  - [CLI Reference](#cli-reference)
    - [`run.py` — Main Entry Point](#runpy--main-entry-point)
    - [`parameter_tuner.py`](#parameter_tunerpy)
    - [`benchmark.py`](#benchmarkpy)
    - [`generate_sample_data.py`](#generate_sample_datapy)
  - [Performance Benchmarks](#performance-benchmarks)
  - [Competition Compliance](#competition-compliance)
  - [Requirements](#requirements)
  - [Recommended Competition Day Workflow](#recommended-competition-day-workflow)
  - [License](#license)
